...
class HacksawRidge extends Component {
                        ...
                        <div className="row">
                            <div className="box">
                                <div className="box-header">
                                    <div id="left" >
                                        <img src="http://jonvilma.com/images/mel-gibson-hacksaw-ridge.jpg" width="200px" align="left" id="margin-bottom" />
                                        <div id="margin-left"> 
                                            <h1>Hacksaw Ridge</h1>
                                            <i>Best Movie Based on True Story</i>
                                            <br/>
                                            <a href="https://www.imdb.com/title/tt2119532/"> <input type="button" className="btn btn-default" value="IMDB"/> </a>
...
export default connect(mapStatetoProps)(HacksawRidge);