...
class Fallout extends Component {
                ...
                <div className="row">
                    <div className="box">
                        <div className="box-header">
                            <div id="left" >
                                <img src="https://i.ytimg.com/vi/wb49-oV0F78/maxresdefault.jpg" width="200px" align="left" id="margin-bottom" />
                                <div id="margin-left"> 
                                    <h1>Mission Impossible Fallout</h1>
                                    <i>Best Action Movie by Tom Cruise</i>
                                    <br/>
                                    <a href="https://www.imdb.com/title/tt4912910/"> <input type="button" className="btn btn-default" value="IMDB"/> </a>
...
export default connect(mapStatetoProps)(Fallout);